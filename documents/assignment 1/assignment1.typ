...
According to the Bike Share Toronto 2023 Business Review, the total number of rides in 2023 is estimated to be about $5.5M$, projected to 2025 to become more than $6.2M$. The total number of stations deployed is planned to be more than $1000$, with more than $10000$ bikes available.
...
#figure(
  ...
  caption: [
    A screenshot of Bike Share Toronto app showing empty terminals at the university in the evening, indicating higher demand than available bikes.
  ],
)
